...
export async function checkSupabaseCreditSchema() {
  ...
  const checks = [
    {
      table: "accounts",
      columns: "credits, tier, unlimited_credits, credits_renew_at",
      migration: "20250608120000_add_credits_renew_at.sql",
    },
    {
...
export async function checkSupabaseAuthSchema() {
  ...
  const checks = [
    ...
    },
    {
      ...
      migration: "20250608130000_email_verification.sql",
      label: "email verification columns",
    },
    {
      table: "auth_tokens",
      columns: "account_id, token_type, token_hash, expires_at",
      migration: "20250608130000_email_verification.sql",
      label: "auth_tokens table",
    },
  ];
